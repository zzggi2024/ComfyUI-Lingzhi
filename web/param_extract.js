...
const PARAM_EXTRACT = "Lingzhi_ParamExtract";
const LAST_TYPE = Symbol("LastType");

app.registerExtension({
    name: "lingzhi.ParamExtract",
    init() {
    ...
    async beforeRegisterNodeDef(nodeType, nodeData) {
        ...
        nodeType.prototype.checkPrimitiveWidget = function ({ node, link }) {
            ...
            const signatureChanged = this.properties.__lingzhiParamExtractSignature !== signature;
            if (signatureChanged) {
                this.properties.__lingzhiParamExtractSignature = signature;
                delete this.properties.__lingzhiParamExtractLockedValue;
            }
            ...
            if (widgetType in ComfyWidgets) {
                ...
                if (!this.widgets?.length) {
                    const lockedValue = this.properties.__lingzhiParamExtractLockedValue;
                    let savedValue;
                    ...
                    widget.callback = (value, ...args) => {
                        this.properties.__lingzhiParamExtractLockedValue = widget.value ?? value;
