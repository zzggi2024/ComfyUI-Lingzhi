...
const QUICKMARK_BASE64_TOKEN_PREFIX = "__LINGZHI_QUICKMARK_BASE64__:";

function getQuickMarkBase64Store() {
    if (!window.__lingzhi_quickmark_base64_store || typeof window.__lingzhi_quickmark_base64_store !== "object") {
        window.__lingzhi_quickmark_base64_store = {};
    }
    return window.__lingzhi_quickmark_base64_store;
}

function installQuickMarkPromptPatch() {
    if (window.__lingzhi_quickmark_prompt_patch_installed) return;
    window.__lingzhi_quickmark_prompt_patch_installed = true;
...
class LingzhiQuickMarkController {
    constructor(node) {
        this.node = node;
...
app.registerExtension({
    name: "lingzhi.quick_mark",
    async beforeRegisterNodeDef(nodeType, nodeData) {
        if (nodeData.name !== "Lingzhi_QuickMark") {
            return;
        }
        ...
        nodeType.prototype.onNodeCreated = function () {
            ...
            this.lingzhiQuickMark = new LingzhiQuickMarkController(this);
            if (this.initButtons) {
                this.initButtons();
            }
        };
