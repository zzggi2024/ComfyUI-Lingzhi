...
const SIZE_PRESET_NODE = "Lingzhi_SizePreset";
const REAL_RATIO_WIDGET = "比例";
const DISPLAY_RATIO_WIDGET = "比例";
const DISPLAY_RATIO_INTERNAL_NAME = "lingzhi_ratio_select";
...
function findRealRatioWidget(node) {
    ...
    return node.widgets.find((widget) => widget && widget.name === REAL_RATIO_WIDGET && widget.__lingzhiRatioDisplay !== true);
}
...
function setupSizePresetRatio(node) {
    ...
    if (!displayWidget) {
        ...
        displayWidget.__lingzhiRatioDisplay = true;
    }
