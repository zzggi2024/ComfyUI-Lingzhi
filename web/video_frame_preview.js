...
const NODE_CLASS = "Lingzhi_VideoFrameNumber";
...
function buildPreviewUrl(state, frameNumber) {
    ...
    return api.apiURL(`/lingzhi/video_frame_preview?${params.toString()}`);
}
...
function createPreviewWidget(node) {
    ...
    node.__lingzhiVideoFramePreview = {
        state,
        input,
        image,
        counter,
...
app.registerExtension({
    name: "Lingzhi.VideoFramePreview",
    async beforeRegisterNodeDef(nodeType, nodeData) {
        ...
        nodeType.prototype.onNodeCreated = function () {
            ...
            if (!this.__lingzhiVideoFramePreview) {
            ...
            this.__lingzhiVideoFramePreview?.syncSize();
            return result;
        };
        ...
        nodeType.prototype.onExecuted = function (message) {
            ...
            const controls = this.__lingzhiVideoFramePreview;
            if (!preview || !controls) {
                return result;
            }
