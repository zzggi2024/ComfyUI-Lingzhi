...
export const MODEL_LOCK_PROPERTY = "lingzhiModelLocked";
...
export function setWidgetVisibility(widget, visible) {
  if (!widget) return;
  if (!widget.__lingzhiEnhancerDisplayState) {
    widget.__lingzhiEnhancerDisplayState = {
      type: widget.type,
      computeSize: widget.computeSize,
    };
  }
  const original = widget.__lingzhiEnhancerDisplayState;
  if (visible) {
